...
class cudaTest
{
    ...
    public static void main(String[] args)
    {
        ...
        float alpha1 = 1.0f, alpha2 = 0.90f;
        ...
        System.out.println("The edge_dimT is: "+edge_dimT[0]);
        ...
        try{
        	nvgraphPagerank(handle, graph, 0, alpha1_p, 0, 0, 1, 0.0f, 1);
        }catch(Exception e){
        ...
        try{
        	nvgraphPagerank(handle, graph, 0, alpha1_p, 0, 1, 1, 0.0f, 1);
    	}catch(Exception e){
